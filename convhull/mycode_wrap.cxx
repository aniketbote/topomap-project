...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__mycode

#else
#  define SWIG_init    init_mycode

#endif
#define SWIG_name    "_mycode"
...
SWIGINTERN PyObject *_wrap_customComputeConvexHull(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:customComputeConvexHull",&obj0)) SWIG_fail;
  {
    std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > *ptr = (std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > *)0;
    int res = swig::asptr(obj0, &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "customComputeConvexHull" "', argument " "1"" of type '" "std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > >""'"); 
    }
    arg1 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
  result = customComputeConvexHull(arg1);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"customComputeConvexHull", _wrap_customComputeConvexHull, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
